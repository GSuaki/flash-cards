...
var CollectionCard = function (_Card) {
  ...
  _createClass(CollectionCard, [{
    ...
    value: function clickListener() {
      ...
      var collectionId = this.props.item.id;
      this.props.fetchCards(collectionId).then(function () {
        return _this2.props.history.push('/collections/' + collectionId + '/flash-cards');
      });
    }
  }]);
...
exports.default = (0, _redux.compose)(_reactRouter.withRouter, (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps))(CollectionCard);

/***/ })

})
//# sourceMappingURL=app.7222816cec402927e37b.hot-update.js.map